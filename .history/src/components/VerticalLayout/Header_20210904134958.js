      ...
      <header id="page-topbar">
        <div className="navbar-header">
          <div className="d-flex">
            ...
            >
              <DropdownToggle
                className="btn header-item font-semibold "
                caret
                tag="button"
              >
                {" "}
                {props.t("Service Menu")} <i className="mdi mdi-chevron-down" />
              </DropdownToggle>
                    ...
                    <Row>
                      ...
                      <Col md={4}>
                        ...
                        <ul className="list-unstyled megamenu-list">
                          ...
                          <li>
                            <Link to="#">{props.t("System Monitoring")}</Link>
                          </li>
                          <li>
                    ...
                    <Row>
                      <Col sm={6}>
                        ...
                        <ul className="list-unstyled megamenu-list">
                          ...
                          <li>
                            <Link to="#">{props.t("Documentation")}</Link>
                          </li>
                          <li>
                          ...
                          <li>
                            <Link to="#">{props.t("Resources")}</Link>
                          </li>
                          <li>
                            <Link to="#">{props.t("Legal")}</Link>
                          </li>
                          <li>
                            <Link to="#">{props.t("How Things Work")}</Link>
                          </li>
                          <li>

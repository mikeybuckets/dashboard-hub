...
const Navbar = props => {
  ...
  const [executive, setexectutive] = useState(false)
  const [domainmanager, setdomainmanager] = useState(false)
  const [dnstools, setdnstools] = useState(false)
              ...
              <ul className="navbar-nav">
                <li className="nav-item dropdown">
                  ...
                  >
                    ...
                    <Link to="/dashboard-executive" className="dropdown-item">
                      {props.t("Executive")}
                    </Link>

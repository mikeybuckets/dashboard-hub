...
const ProjectsOverview = props => {
  ...
  const { projectDetail } = useSelector(state => ({
    projectDetail: state.projects.projectDetails,
  }))
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <MetaTags>
          <title>Project Overview | DivOps Dashboard - Hub</title>
        </MetaTags>
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title="Projects" breadcrumbItem="Project Overvieww" />
